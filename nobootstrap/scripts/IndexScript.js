...
async function getNews() {
    ...
    function ReturnArticle(i) {
        ...
        return articleString = '<div class=""><div class=""><a class="ArticleLink" onclick="SendJson(' + i + ')" href="pages/DetailedView.html"><h2 class="overflow">' + data.articles[i].title + '</h2><img width="100%" height="400" src=' + data.articles[i].urlToImage + '></a></div></div>';
    }
